...
- v2.4 PR4：新增知识/观点 Profile，与访谈共享分析流程；创建任务可选五种内容类型、有效 Prompt 和 AI Provider。任务默认分析遵循创建选择，Provider 配置变化时在调用前明确阻断；保持旧任务和康熙流程兼容。正式 v2.4 仍须通过真实素材与人工验收。

- v2.4 PR3：新增人物访谈 Profile 与独立 Prompt，复用统一内容召回、上下文扩展、全局评审和 AI checkpoint；故事评分可在审片页追溯，康熙流程保持兼容。五模板创建 UI 和真实素材验收在后续 PR 完成。

### Internal

- v2.4 PR6 验收记录：区分已部署功能、冻结响应回放、真实模型结果与人工质量结论，保留匿名 A/B 材料和版本门禁；同步中英文首页及路线图。人工和新类型素材验收未通过前，保持 2.3.0 版本号。

- v2.4 PR5：新综艺分析冻结当轮审片反馈并保存到分析证据；后续 Job 恢复沿用原策略快照，避免新反馈或快照字段升级导致错误冲突。旧 Job、旧 Prompt、旧 checkpoint 与评分行为保持兼容；正式版本验收尚未完成。

...
PR1 #93 合并 `4264e31`，PR2 #94 合并 `cc8ae63`；PR3 #95 合并 `06d4d12` 并部署，11 条迁移、旧数据与 Worker 正常。旧任务新执行冻结当次版本，旧 Job/Run 未回填、不改指纹。当前独立 PR4 增加知识模板、五类型创建页、Prompt/Provider 选择与配置身份冻结；最终测试/CI/部署见 PROJECT_STATUS。三集康熙历史响应回放结果/请求指纹一致，真实人工验收及两个新类型各两条素材仍为 PR5 门禁。
...
| 2.4-5 | 三集对比、版本与运行交付 | 确定性回放一致、真实人工盲审通过 |

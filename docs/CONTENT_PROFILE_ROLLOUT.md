...
PR1 #93 合并 `4264e31`，PR2 #94 合并 `cc8ae63`，PR3 #95 合并 `06d4d12`，PR4 #96 合并 `a5ece66`，PR5 #97 合并 `4eaff62` 并部署，12 条迁移、旧数据与 Worker 正常。五 Profile、创建页、Prompt/Provider 选择和 Judge 反馈快照已接入；followup 复用保持旧快照兼容，不改变评分/Prompt/旧指纹。PR6 收集真实质量证据：人工验收及两个新类型各两条素材仍是门禁，不能以部署功能或确定性回放代替。实际测试/CI/运行证据见 PROJECT_STATUS，正式版本仍为 2.3.0。

...
本文记录已批准的实施边界；目标能力不等于已上线能力。当前工程版本为 2.5.5，实际发布/部署状态以 PROJECT_STATUS 为准。
...
v2.5.0 已发布并部署到原服务。v2.5.5 按 PR #105 人工观察、#106 冻结报告、#107 Challenger 草稿、#108 显式试验任务、#109 官方实验/独立人工启用顺序合并并通过各自 CI。当前做最终版本、Windows 实机、既有目标部署与回滚证据验收；实际节目效果仍待日常验证。Challenger 首版只改 Prompt，完整保留 Profile/评分证据，不声称不受支持的自定义评分已执行。验收通过才进入 v2.6。
